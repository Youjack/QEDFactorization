...
const setname = "QED_electron_DF_nlo"
...
info_str = """
SetDesc:         "QED distribution functions of electron, evolved from NLO initial conditions."
Authors:         Lin Youjack
Reference:       N/A
Format:          lhagrid1
DataVersion:     1
...
f̂v_mμ = evolve_nonsinglet_f̂_from_μ₀²_to_μ²(αEMe, s-> f̂ll₀(αEMe,s),                me^2, mμ^2, 1)
f̂s_mμ = evolve_singlet_f̂_from_μ₀²_to_μ²(   αEMe, s->[f̂ll₀(αEMe,s); f̂γl₀(αEMe,s)], me^2, mμ^2, 1)

# μ > mμ
f̂vμ²(μ²) = evolve_nonsinglet_f̂_from_μ₀²_to_μ²(αEMμ, f̂v_mμ, mμ^2, μ², 2)
f̂sμ²(μ²) = evolve_singlet_f̂_from_μ₀²_to_μ²(   αEMμ, f̂s_mμ, mμ^2, μ², 2)
f̂eμ²(μ²) = s -> ( f̂sμ²(μ²)(s)[1] + f̂vμ²(μ²)(s) )/2
f̂ēμ²(μ²) = s -> ( f̂sμ²(μ²)(s)[1] - f̂vμ²(μ²)(s) )/2
f̂γμ²(μ²) = s ->   f̂sμ²(μ²)(s)[2]
