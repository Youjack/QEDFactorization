...
info_str = """
SetDesc:         "QED distribution functions of muon, evolved from NLO initial conditions."
Authors:         Lin Youjack
Reference:       N/A
Format:          lhagrid1
DataVersion:     1
...
# μ > mμ
f̂vμ²(μ²) = evolve_nonsinglet_f̂_from_μ₀²_to_μ²(αEMμ, s-> f̂ll₀(αEMμ,s),                mμ^2, μ², 2)
f̂sμ²(μ²) = evolve_singlet_f̂_from_μ₀²_to_μ²(   αEMμ, s->[f̂ll₀(αEMμ,s); f̂γl₀(αEMμ,s)], mμ^2, μ², 2)
