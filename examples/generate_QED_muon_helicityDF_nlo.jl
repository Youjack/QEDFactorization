...
const setname = "QED_muon_helicityDF_nlo"
const id = 13
...
info_str = """
SetDesc:         "QED helicity distribution functions of muon, evolved from NLO initial conditions."
Authors:         Lin Youjack
Reference:       N/A
Format:          lhagrid1
DataVersion:     1
...
# μ > mμ
ĝvμ²(μ²) = evolve_nonsinglet_ĝ_from_μ₀²_to_μ²(αEMμ, s-> ĝll₀(αEMμ,s),                mμ^2, μ², 2)
ĝsμ²(μ²) = evolve_singlet_ĝ_from_μ₀²_to_μ²(   αEMμ, s->[ĝll₀(αEMμ,s); ĝγl₀(αEMμ,s)], mμ^2, μ², 2)
