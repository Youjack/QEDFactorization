...
const setname = "QED_electron_DF_lo"
...
info_str = """
SetDesc:         "QED distribution functions of electron, evolved from LO initial conditions."
Authors:         Lin Youjack
Reference:       N/A
Format:          lhagrid1
DataVersion:     1
...
f̂v_mμ = evolve_nonsinglet_f̂_from_μ₀²_to_μ²(αEMe, s-> 1,     me^2, mμ^2, 1)
f̂s_mμ = evolve_singlet_f̂_from_μ₀²_to_μ²(   αEMe, s->[1; 0], me^2, mμ^2, 1)
